...
{
    private Dictionary<string, IPanel> panelDic = null;
    private Dictionary<string, IPanel> secendLevelPanelDic = null;
    ...
    {
        foreach (KeyValuePair<string, IPanel> data in secendLevelPanelDic)
        {
        ...
        foreach (KeyValuePair<string, IPanel> data in deleteDic)
        {
            if (data.Value == null)
            {
                continue;
